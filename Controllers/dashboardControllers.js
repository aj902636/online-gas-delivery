...
const { where, update } = require("../Models/users");
...
exports.profile = function(req, res, next){
    ...
    .exec(function(err, userData){
        if(err){
            ...
            res.render('profile',{userData:userData,username:username,profileImage:profileImage});
        }
    })
}
...
exports.changePassword = (req, res, next)=>{
    let username = req.username;
    let profileImage = req.user.profileImage;
    res.render('changePassword',{username:username,profileImage:profileImage});
}

exports.changeVenderPassword = function(req, res, next){
    Users.find()
